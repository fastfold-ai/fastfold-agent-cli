...
3. **bundled** — ``src/ct/skills/`` shipped inside the package.
...
from ct.agent.config import CONFIG_DIR

logger = logging.getLogger("ct.skills")
        ...
        if directory is not None:
            ...
            if has_scripts:
                ...
                header += (
                    ...
                    f"Do NOT use repo-relative paths like `src/ct/skills/...`, a bare `scripts/...`, "
