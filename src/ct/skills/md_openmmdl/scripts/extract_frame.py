#!/usr/bin/env python3
"""
Extract a PDB frame from a completed OpenMMDL workflow trajectory.
...
from ct.skills.md_openmmdl.scripts._api import http_json
from ct.skills.md_openmmdl.scripts.load_env import resolve_fastfold_api_key
from ct.skills.md_openmmdl.scripts.security_utils import (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Extract a trajectory frame from a completed FastFold OpenMMDL workflow as PDB.",
    )
    parser.add_argument("workflow_id", help="OpenMMDL workflow ID.")
