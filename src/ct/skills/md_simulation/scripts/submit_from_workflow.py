...
def main() -> None:
    ...
    try:
        ...
        sys.exit(
            ...
            "If you only know the UniProt accession, use fastfold-md-fetch-uniprot and then fastfold-md-submit-manual-af-pae. "
            "If the source is a FastFold fold job, use fastfold-md-submit-from-fold-job instead."
